...
def test_valid_transitions():
    ...
    assert MemoryLifecycleManager.is_valid_transition("CANDIDATE", "ACTIVE")
...
def test_invalid_transitions():
    ...
    # Candidate cannot jump to superseded
    assert not MemoryLifecycleManager.is_valid_transition("CANDIDATE", "SUPERSEDED")
...
def test_lifecycle_manager_transition_application():
    ...
    # 2. Valid transition: STALE -> ACTIVE (Reverified)
