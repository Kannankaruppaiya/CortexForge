...
def upgrade() -> None:
    ...
    op.add_column('memory_relations', sa.Column('project_id', sa.String(length=36), nullable=True))
    ...
    op.add_column('failure_episodes', sa.Column('root_cause_claim_id', sa.String(length=36), nullable=True))
    op.add_column('failure_episodes', sa.Column('root_cause_details', sa.JSON(), nullable=True))
    op.create_index('idx_fail_root_cause_claim', 'failure_episodes', ['root_cause_claim_id'])
