...
def upgrade() -> None:
    op.add_column('agent_tasks', sa.Column('workspace_id', sa.String(length=100), nullable=True))
    op.add_column('agent_tasks', sa.Column('session_id', sa.String(length=100), nullable=True))
    op.add_column('agent_tasks', sa.Column('parent_task_id', sa.String(length=36), nullable=True))
    op.add_column('agent_tasks', sa.Column('provider', sa.String(length=50), nullable=True))
    op.add_column('agent_tasks', sa.Column('model', sa.String(length=100), nullable=True))
    op.add_column('agent_tasks', sa.Column('model_version', sa.String(length=50), nullable=True))
