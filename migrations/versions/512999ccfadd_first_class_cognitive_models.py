...
down_revision: Union[str, Sequence[str], None] = '043888bcfadd'
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('memories', schema=None) as batch_op:
        batch_op.add_column(sa.Column('scope', sa.String(length=50), server_default='PROJECT', nullable=False))
        batch_op.add_column(sa.Column('valid_from_commit', sa.String(length=64), nullable=True))
        batch_op.add_column(sa.Column('valid_to_commit', sa.String(length=64), nullable=True))
        batch_op.add_column(sa.Column('valid_from_time', sa.DateTime(timezone=True), nullable=True))
        batch_op.add_column(sa.Column('valid_to_time', sa.DateTime(timezone=True), nullable=True))
        batch_op.create_index('idx_mem_project_scope', ['project_id', 'scope'], unique=False)
    ...
    with op.batch_alter_table('memory_versions', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('actor', sa.String(length=100), server_default='system', nullable=False))
    ...
    op.create_table(
        ...
        sa.Column('author', sa.String(length=255), server_default='unknown', nullable=False),
        sa.Column('message', sa.Text(), nullable=False),
        sa.Column('committed_at', sa.DateTime(timezone=True), nullable=False),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    )
    op.create_index('idx_commit_project_sha', 'commits', ['project_id', 'commit_sha'], unique=True)
    ...
    op.create_table(
        'file_changes',
        sa.Column('id', sa.String(length=36), primary_key=True),
        sa.Column('change_set_id', sa.String(length=36), sa.ForeignKey('change_sets.id', ondelete='CASCADE'), nullable=False),
    ...
    op.create_index('idx_filechange_set_path', 'file_changes', ['change_set_id', 'file_path'], unique=False)
    ...
    op.create_table(
        ...
        sa.Column('old_symbol_id', sa.String(length=36), sa.ForeignKey('code_entities.id', ondelete='SET NULL'), nullable=True),
        sa.Column('new_symbol_id', sa.String(length=36), sa.ForeignKey('code_entities.id', ondelete='SET NULL'), nullable=True),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    )
    op.create_index('idx_symbolchange_set_qualified', 'symbol_changes', ['change_set_id', 'qualified_name'], unique=False)
    ...
    op.create_table(
        ...
        sa.Column('framework', sa.String(length=50), server_default='pytest', nullable=False),
        sa.Column('status', sa.String(length=50), server_default='PASSED', nullable=False),
    ...
    op.create_index('idx_testrun_project_commit', 'test_runs', ['project_id', 'commit_sha'], unique=False)

    # 8. Create test_case_results
    op.create_table(
        'test_case_results',
        sa.Column('id', sa.String(length=36), primary_key=True),
        sa.Column('test_run_id', sa.String(length=36), sa.ForeignKey('test_runs.id', ondelete='CASCADE'), nullable=False),
    ...
    op.create_index('idx_testcase_run_status', 'test_case_results', ['test_run_id', 'status'], unique=False)
    op.create_index('idx_testcase_signature', 'test_case_results', ['failure_signature'], unique=False)
    ...
    op.create_table(
        ...
        sa.Column('project_id', sa.String(length=36), sa.ForeignKey('projects.id', ondelete='CASCADE'), nullable=False),
        sa.Column('task_id', sa.String(length=36), sa.ForeignKey('agent_tasks.id', ondelete='SET NULL'), nullable=True),
        sa.Column('test_case_result_id', sa.String(length=36), sa.ForeignKey('test_case_results.id', ondelete='SET NULL'), nullable=True),
        sa.Column('failure_signature', sa.String(length=64), nullable=False),
        sa.Column('error_class', sa.String(length=100), server_default='Error', nullable=False),
    ...
    op.create_index('idx_fail_project_sig', 'failure_episodes', ['project_id', 'failure_signature'], unique=False)
    ...
    op.create_table(
        ...
        sa.Column('enforcement_status', sa.String(length=50), server_default='ACTIVE', nullable=False),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    )
    ...
    op.create_table(
        'rule_violations',
        sa.Column('id', sa.String(length=36), primary_key=True),
        sa.Column('rule_id', sa.String(length=36), sa.ForeignKey('architecture_rules.id', ondelete='CASCADE'), nullable=False),
        sa.Column('source_entity_id', sa.String(length=36), sa.ForeignKey('code_entities.id', ondelete='CASCADE'), nullable=False),
        sa.Column('target_entity_id', sa.String(length=36), sa.ForeignKey('code_entities.id', ondelete='CASCADE'), nullable=False),
        sa.Column('commit_sha', sa.String(length=64), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('project_id', sa.String(length=36), sa.ForeignKey('projects.id', ondelete='CASCADE'), nullable=False),
        sa.Column('commit_sha', sa.String(length=64), nullable=False),
        sa.Column('reviewer', sa.String(length=100), server_default='cortex-reviewer', nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('project_id', sa.String(length=36), sa.ForeignKey('projects.id', ondelete='CASCADE'), nullable=False),
        sa.Column('commit_sha', sa.String(length=64), nullable=False),
        sa.Column('cognitive_generation', sa.Integer(), server_default='1', nullable=False),
        sa.Column('memory_generation', sa.Integer(), server_default='1', nullable=False),
        ...
        sa.Column('active_memories_count', sa.Integer(), server_default='0', nullable=False),
        sa.Column('stale_memories_count', sa.Integer(), server_default='0', nullable=False),
        sa.Column('conflicted_memories_count', sa.Integer(), server_default='0', nullable=False),
        sa.Column('retrieval_version', sa.String(length=50), server_default='v2', nullable=False),
        sa.Column('embedding_version', sa.String(length=50), server_default='1.0.0', nullable=False),
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    )
    op.create_index('idx_cogsnap_project_commit', 'cognitive_snapshots', ['project_id', 'commit_sha'], unique=False)
